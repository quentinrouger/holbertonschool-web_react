...
class Notifications extends Component {
  ...
  render() {
    ...
    if (noNewNotifications) content = <p>No new notification for now</p>;
      ...
      content = Object.values(listNotifications).map((notification) =>
      <NotificationItem key={notification.guid || notification.id} type={notification.type} value={notification.value} html={notification.html} markAsRead={this.props.markNotificationAsRead} id={notification.guid || notification.id}/>);
    }
